...
class AuthServices {
  ...
  static Future<User> saveUser(dynamic jsonObject) async {
    ...
    try {
      ...
      FirebaseService.firebaseMessaging.subscribeToTopic("v_${currentUser.vendor_id}");
  ...
  static void logout() async {
    ...
    await LocalStorageService.prefs.setBool(AppStrings.firstTimeOnApp, false);
    FirebaseService.firebaseMessaging.unsubscribeFromTopic("v_${currentUser.vendor_id}");
