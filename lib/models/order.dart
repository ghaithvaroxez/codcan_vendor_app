...
class Order {
  ...
  factory Order.fromJson(dynamic json) {
    return Order(
      ...
      subTotal: json["sub_total"] == null ? null : double.parse(json["sub_total"].toString()),
      ...
      comission:
          json["comission"] == null ? null : double.parse(json["comission"].toString()),
      //
  ...
  get canChatDriver =>
      driver != null && ["preparing", "enroute"].contains(status);
}
